...
| --------------------------- | -------------------------------------------------------- | ------- | ------- | ----- |
| WordCount                   | DSL, aggregation, stateful                               | [Java 8+ example](src/main/java/io/confluent/examples/streams/TopicMessagesCounter.java) | | [Scala Example](src/main/scala/io/confluent/examples/streams/WordCountScalaExample.scala) |
...
in the [java docs](src/main/java/io/confluent/examples/streams/TopicMessagesCounter.java#L31) of each example code.
